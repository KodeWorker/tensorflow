...
class SaveDIT : public OpKernel {
 public:
  explicit SaveDIT(OpKernelConstruction* context) : OpKernel(context) {}
...
class RestoreDIT : public OpKernel {
 public:
  explicit RestoreDIT(OpKernelConstruction* context) : OpKernel(context) {
...
class MergeDITCheckpoints : public OpKernel {
 public:
  explicit MergeDITCheckpoints(OpKernelConstruction* context)
      : OpKernel(context) {
    OP_REQUIRES_OK(context,
